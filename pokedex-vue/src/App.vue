...
// fazer header/footer -- baixar font pokemon 
  ...
  <v-app>
    ...
    <v-container>  
        <v-container>
          ...
          <v-text-field v-model="search" label="Pesquisar Pokémon" placeholder="Bulbasaur..." solo></v-text-field>
            ...
            <v-col cols="2" v-for="pokemon in filtered_pokemons" :key="pokemon.name">
              <v-card @click="show_pokemon(get_id(pokemon))">
                <v-container>
                  ...
                  :alt="pokemon.name" width="80%" class="ml-5"/>
        ...
        <v-container>
          <v-row class="d-flex align-center">
            ...
            <v-col cols="8">
              ...
              <v-chip label class="ml-2"><span>Peso: {{ (selected_pokemon.weight * 0.45359237).toFixed(0)}} kg</span></v-chip>
            </v-col>
          </v-row>
...
#app {
  ...
  background: linear-gradient(0deg, rgba(255,222,0,0.835171568627451) 20%, rgba(59,76,170,1) 75%);
}
</style>
